...
class SightingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post sightings_url, params: { sighting: { animal_id: @sighting.animal_id, latitude: @sighting.latitude, longitude: @sighting.longitude, notes: @sighting.notes } }
    end
  ...
  test "should update sighting" do
    patch sighting_url(@sighting), params: { sighting: { animal_id: @sighting.animal_id, latitude: @sighting.latitude, longitude: @sighting.longitude, notes: @sighting.notes } }
